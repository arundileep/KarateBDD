Feature: ActiveMQ REST API - Test Suite 21
  ...
  Background: Init
    ...
    * configure followRedirects = false
    ...
    Given url "http://10.1.0.63:8161"
    And header Authorization = auth


  Scenario: Producing & Consuming Message
    Given path "/api/message"
    And param destination = "queue://arun.input"
    And header Connection = "Keep-Alive"
    And request "Hi, Karate - Welcome to ActiveMQ"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/arun.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi, Karate - Welcome to ActiveMQ"
